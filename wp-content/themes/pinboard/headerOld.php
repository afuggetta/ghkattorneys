...
<body <?php body_class() ?>>
	<div id="wrapper">
                <header id="header" style="height: 480px;">
			<<?php pinboard_title_tag( 'site' ); ?> id="site-title" style="height: 150px;">
				<?php if ( ( '' != get_header_image() ) &&  ( false != get_header_image() ) ) : ?>
					<a href="<?php echo home_url( '/' ); ?>" rel="home">
						<img src="<?php header_image(); ?>" alt="<?php bloginfo( 'name' ); ?>" style="height: 96px;position: relative;top: -11px;left: -11px;"
