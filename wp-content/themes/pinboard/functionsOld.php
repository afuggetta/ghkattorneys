...
function pinboard_theme_setup() {
	...
	register_nav_menus(
		array(
			...
			'footer_nav' => 'Footer Menu', // You can add more menus here
		)
	);
	...
	// Register People
	$labels = array(
		'name' => _x('Attorneys', 'post type general name','Flexible'),
		'singular_name' => _x('Attorney', 'post type singular name','Flexible'),
		'add_new' => _x('Add New', 'Attorney item','Flexible'),
		'add_new_item' => __('Add New Attorney','Flexible'),
		'edit_item' => __('Edit Attorney','Flexible'),
		'new_item' => __('New Attorney','Flexible'),
		'all_items' => __('All Attorneys','Flexible'),
		'view_item' => __('View Attorney','Flexible'),
		'search_items' => __('Search Attorneys','Flexible'),
	...
	$args = array(
		...
		'show_ui' => true,
		'query_var' => true,
		'rewrite' => apply_filters( 'et_portfolio_posttype_rewrite_args', array( 'slug' => 'attorney', 'with_front' => false ) ),
	...
	function my_get_posts( $query ) {
		...
		if ( is_home() && $query->is_main_query() )
			$query->set( 'post_type', array( 'visa' ) );
...
function themes_taxonomy() {
	register_taxonomy(
		'visa_categories',  //The name of the taxonomy. Name should be in slug form (must not contain capital letters or spaces).
		'visa',   		 //post type name
		array(
			'hierarchical' 		=> true,
			'label' 			=> 'Visa Categorys',  //Display name
			'query_var' 		=> true,
			'rewrite'			=> array(
					'slug' 			=> 'visas', // This controls the base slug that will display before each term
...
function register_themepost() {
	...
	// Register custom Post Types
		$labels = array(
		'name' => _x('Visas', 'post type general name','Flexible'),
		'singular_name' => _x('Visa', 'post type singular name','Flexible'),
		'add_new' => _x('Add New', 'Visa item','Flexible'),
		'add_new_item' => __('Add New Visa','Flexible'),
		'edit_item' => __('Edit Visa','Flexible'),
		'new_item' => __('New Visa','Flexible'),
		'all_items' => __('All Visas','Flexible'),
		'view_item' => __('View Visa','Flexible'),
		'search_items' => __('Search Visas','Flexible'),
		'not_found' =>  __('Nothing found','Flexible'),
		'not_found_in_trash' => __('Nothing found in Trash','Flexible'),
		'parent_item_colon' => ''
	);
	...
	$args = array(
		...
		'show_ui' => true,
		'query_var' => true,
		'rewrite' => apply_filters( 'et_portfolio_posttype_rewrite_args', array( 'slug' => 'visa', 'with_front' => false ) ),
		'capability_type' => 'post',
		'hierarchical' => false,
		'menu_position' => null,
		'supports' => array('title','editor','thumbnail','excerpt','comments','revisions','custom-fields'),
...
function filter_search($query) {
    if ($query->is_search) {
	$query->set('post_type', array('visa', 'attourney', 'post'));
    };
    return $query;
};
...
function pinboard_register_styles() {
	...
	wp_register_style( 'metrojs', get_template_directory_uri() . '/scripts/metro-js/MetroJs.min.css', false, null); 
}
endif;
...
function pinboard_register_scripts() {
	...
	wp_register_script( 'metrojs', get_template_directory_uri() . '/scripts/metro-js/MetroJs.min.js', array( 'jquery' ), null );
}
endif;
