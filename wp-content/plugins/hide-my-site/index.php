		...
		if( (empty($_COOKIE[$this->get_cookie_name()])) AND (empty($cookie_just_set)) ) {
				...
				echo "
					<style>
						...
						body { background: url(".plugins_url('images/background/background.png' , __FILE__).") center center rgba(111, 122, 151, 0.28); font-family:Arial;}
						...
						<![endif]-->
					<body>
						<div id='form_wrap'  style='display:none;'>
							<form method=post>
						...
						<div id='placeholder'>
							<img src='http://ghkattorneys.com/wp-content/uploads/2013/08/GHK.png' />
							<h1>London's newest US Corporate and Media Immigration Law Firm Launching September 2013</h1>
							<p>28 Grosvenor Street, London W1K 4QR - +44 (0) 207 769-6768<br />info@ghkattorneys.com</a></p>
						</div>
					</body>
				";
				exit;
